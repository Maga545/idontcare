...
photo = open(r'C:\Users\MagaShih\Desktop\shop\FIRE SHOP.png', 'rb')
...
def start_bot():
    ...
    def handler_start(message):
        ...
        if func.is_kur(message.chat.id):
            ...
            bot.send_message(chat_id=chat_id,
                             text=f'{message.from_user.first_name},добро пожаловать в Fire Shop🔥!.\n✔Используй оригинал бота \n❓Поддержка:https://t.me/firebotsupport',
                             reply_markup=menu.kur_main_menu)
        elif message.from_user.id == int('6547789052'):
            bot.send_photo(chat_id=message.chat.id, photo=photo)
            bot.send_message(chat_id=chat_id,
                             text=f'{message.from_user.first_name},добро пожаловать в Fire Shop🔥!.\n✔Используй оригинал бота \n❓Поддержка:https://t.me/firebotsupport',
    ...
    def handler_call(call):
        ...
        if call.data == 'shop':
            ...
            keyboard1.add(
                types.InlineKeyboardButton('Открыть Магазин🛍', url='https://onlinesim.io/ru'))
            ...
            try:
                ...
                bot.edit_message_text(chat_id=chat_id, message_id=message_id, text='[📦]Вот категории товаров',
        ...
        if call.data in func.parent_list():
            ...
            try:
                ...
                bot.edit_message_text(chat_id=chat_id, message_id=message_id, text='[🔥]Список товаров:',
        ...
        if call.data in func.catalog_list():
            ...
            try:
                ...
                print(id)
                bot.edit_message_text(chat_id=chat_id, message_id=message_id, text='✔Выбирай:',
