...
main_menu.add(types.InlineKeyboardButton(text='📖 Тех. Поддержка', url='https://t.me/firebotsupport'))
...
adm_main_menu.add(types.InlineKeyboardButton(text='📖 Тех. Поддержка', url='https://t.me/firebotsupport'))
...
kur_main_menu.add(types.InlineKeyboardButton(text='📖 Тех. Поддержка', url='https://t.me/firebotsupport'))
...
payments_config = types.InlineKeyboardMarkup(row_width=2)
payments_config.add(
